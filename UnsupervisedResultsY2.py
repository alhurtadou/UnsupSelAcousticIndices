...
filename = "D:/UNALAcademico/2023/Proyecto/proyectoPTA/unsupervised/Results/ClasificacionIndicesYataros2.csv"
filename1 = "D:/UNALAcademico/2023/Proyecto/proyectoPTA/unsupervised/Results/ClasificacionIndicesYataros2Labels2T.csv"
...
def CorrelationYataros2Bar():
    ...
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2_barChart_B5.pdf') 
    plt.show()
    #plt.savefig("D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2B5Bar.pdf", format='pdf', bbox_inches= 'tight')
    
    
#----------------------------------------------------------------------------------------------------------------------#    
def CorrelationYataros2DiaBar():
    #labels = list(range(35,40))
    labels = ["5th Best", "4th Best", "3rd Best", "2nd Best",  "Best"]
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2Dia_barChart_B5.pdf') 
    plt.show()

#----------------------------------------------------------------------------------------------------------------------#            
def CorrelationYataros2NocheBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2Noche_barChart_B5.pdf') 
    plt.show()


#----------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros2MorningBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2Morning_barChart_B5.pdf') 
    plt.show()
#----------------------------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros2AfternoonBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2afternoon_barChart_B5.pdf') 
    plt.show()

#-------------------------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros2EveningBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2Evening_barChart_B5.pdf') 
    plt.show()

#-------------------------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros2AfterMidnightBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2AfterMidnight_barChart_B5.pdf') 
    plt.show()
...
def todosDatos():
    ...
    plt.colorbar()
    plt.title("YAT2 all feature selection methods per dataset")
    plt.savefig("D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2.pdf", format='pdf', bbox_inches= 'tight')
    ...
    plt.colorbar()
    plt.title("YAT2 all datasets per feature selection method")
    
    plt.savefig("D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros2Methods.pdf", format='pdf', bbox_inches= 'tight')
    #plt.show()
...
todosDatos()   
#Generate bar plots
CorrelationYataros2Bar()
CorrelationYataros2DiaBar()
CorrelationYataros2NocheBar()
CorrelationYataros2MorningBar()
CorrelationYataros2AfternoonBar()
CorrelationYataros2EveningBar()
CorrelationYataros2AfterMidnightBar()
