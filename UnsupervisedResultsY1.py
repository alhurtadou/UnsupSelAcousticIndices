...
filename = "D:/UNALAcademico/2023/Proyecto/proyectoPTA/unsupervised/Results/ClasificacionIndicesYataros1.csv"
filename1 = "D:/UNALAcademico/2023/Proyecto/proyectoPTA/unsupervised/Results/ClasificacionIndicesYataros1Labels1T.csv"
...
def CorrelationYataros1Bar():
    ...
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1_barChart_B5.pdf') 
    plt.show()
    #plt.savefig("D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1B5Bar.pdf", format='pdf', bbox_inches= 'tight')
    
    
#----------------------------------------------------------------------------------------------------------------------#    
def CorrelationYataros1DiaBar():
    #labels = list(range(35,40))
    labels = ["5th Best", "4th Best", "3rd Best", "2nd Best",  "Best"]
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1Dia_barChart_B5.pdf') 
    plt.show()

#----------------------------------------------------------------------------------------------------------------------#            
def CorrelationYataros1NocheBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1Noche_barChart_B5.pdf') 
    plt.show()


#----------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros1MorningBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1Morning_barChart_B5.pdf') 
    plt.show()
#----------------------------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros1AfternoonBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1afternoon_barChart_B5.pdf') 
    plt.show()

#-------------------------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros1EveningBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1Evening_barChart_B5.pdf') 
    plt.show()

#-------------------------------------------------------------------------------------------------------------------------------------#
def CorrelationYataros1AfterMidnightBar():
    ...
    plt.legend(bbox_to_anchor=(0, 1, 1, 0), loc="lower left", mode="expand", ncol=6, fontsize=12)
    fig.tight_layout()
    plt.savefig('D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1AfterMidnight_barChart_B5.pdf') 
    plt.show()
...
def todosDatos():
    ...
    plt.colorbar()
    plt.title("YAT1 all feature selection methods per dataset")
    plt.savefig("D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1.pdf", format='pdf', bbox_inches= 'tight')
    ...
    plt.colorbar()
    plt.title("YAT1 all datasets per feature selection method")
    
    plt.savefig("D://UNALAcademico//2023//Proyecto//proyectoPTA//unsupervised//Yataros1Methods.pdf", format='pdf', bbox_inches= 'tight')
    #plt.show()
...
todosDatos()   
#Generate bar plots
CorrelationYataros1Bar()
CorrelationYataros1DiaBar()
CorrelationYataros1NocheBar()
CorrelationYataros1MorningBar()
CorrelationYataros1AfternoonBar()
CorrelationYataros1EveningBar()
CorrelationYataros1AfterMidnightBar()
